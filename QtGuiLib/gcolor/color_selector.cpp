    ...
    Color_Preview(parent), p(new Private(this))
{
   ...
   connect(p->dialog, SIGNAL(colorSelected(QColor)), this, SLOT(slotColorSelected(QColor)));
   connect(this, SIGNAL(colorAbstractionChanged(QColor)), this, SLOT(slotColorAbstractionChanged(QColor)));
...
void Color_Selector::slotColorSelected(QColor _color)
{
   emit colorSelected(_color);
}
void Color_Selector::AbstractionColorChanged(QColor _color)
{
   emit colorAbstractionChanged(_color);
}

void Color_Selector::slotColorAbstractionChanged(QColor _color)
{
   setColor(_color);
}
